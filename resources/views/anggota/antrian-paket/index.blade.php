...
@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-text">Antrian Buku Paket</h2>
</div>

@if($antrianAktif)
<!-- Section 1: Active Queue -->
<div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 mb-8 text-center max-w-lg mx-auto">
