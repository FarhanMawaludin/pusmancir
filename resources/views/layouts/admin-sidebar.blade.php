<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white ">
        <ul class="space-y-2 font-medium ">
            ...
            <li class="mb-4">
                <button type="button"
                    class="flex items-center w-full p-2 text-base rounded group {{ $activeMenu == 'antrianPaket' ? 'text-white bg-blue-700' : 'text-gray-400 hover:bg-gray-100  ' }}"
                    aria-controls="dropdown-example-antrian-paket" data-collapse-toggle="dropdown-example-antrian-paket">
                ...
                <ul id="dropdown-example-antrian-paket" class="{{ $activeMenu == 'antrianPaket' ? '' : 'hidden' }} py-2 space-y-2">
                    <li>
                        <a href="{{ route('admin.antrian-paket.setting') }}"
                            class="flex items-center w-full p-2 text-gray-400 transition duration-75 rounded pl-11 group hover:bg-gray-100  ">
                            Pengaturan Kuota</a>
                    </li>
                    <li>
            ...
            @if (Auth::user()->role !== 'pustakawan')
                ...
                <li class="text-xs px-2 text-text uppercase">Manajemen Pengaduan</li>

                <li class="mb-4">
                    <a href="{{ route('admin.pengaduan.index') }}"
                        class="flex items-center p-2 rounded group {{ $activeMenu == 'pengaduan' ? 'text-white bg-blue-700' : 'text-gray-400 hover:bg-gray-100  ' }}">
                        <svg class="w-5 h-5 {{ $activeMenu == 'pengaduan' ? 'text-white' : 'text-base300 ' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        ...
                        <span class="ml-3 {{ $activeMenu == 'pengaduan' ? 'text-white' : 'text-base300' }}">Pengaduan</span>
                    </a>
                </li>
