        ...
        <ul class="space-y-2 font-medium ">
            ...
            <li>
                <a href="{{ route('anggota.katalog-paket.index') }}"
                    class="flex items-center p-2 rounded group {{ $activeMenu == 'katalogPaket' ? 'text-white bg-blue-700' : 'text-gray-900 hover:bg-gray-100  ' }}">
                    <svg class="w-5 h-5 {{ $activeMenu == 'katalogPaket' ? 'text-white' : 'text-base300 ' }}"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M5 19V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v13H7a2 2 0 0 0-2 2Zm0 0a2 2 0 0 0 2 2h12M9 3v14m7 0v4" />
                    </svg>
                    <span class="ml-3 {{ $activeMenu == 'katalogPaket' ? 'text-white' : 'text-base300' }}">Katalog
                        Buku Paket</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('anggota.peminjaman-paket.index') }}"
                    class="flex items-center p-2 rounded group {{ $activeMenu == 'peminjamanPaket' ? 'text-white bg-blue-700' : 'text-gray-900 hover:bg-gray-100  ' }}">
                    <svg class="w-5 h-5 {{ $activeMenu == 'peminjamanPaket' ? 'text-white' : 'text-base300 ' }}"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 7.757v8.486M7.757 12h8.486M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                    ...
                    <span
                        class="ml-3 {{ $activeMenu == 'peminjamanPaket' ? 'text-white' : 'text-base300' }}">Peminjaman Paket</span>
                </a>
            </li>
