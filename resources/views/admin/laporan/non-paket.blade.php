...
@section('content')
    <div class="flex justify-between items-center w-full">
        ...
        <section class="mb-2 w-full"> <!-- ✅ DITAMBAHKAN w-full -->
            ...
            <div class="mb-4">
                <form method="GET" action="{{ route('admin.laporan.non-paket') }}" class="flex flex-wrap items-center gap-3 mb-4">
                    ...
                    <a href="{{ route('admin.laporan.exportNonPaketPdf', request()->all()) }}"
